...
sub UpdateFine {
    ...
    if ( my $data = $sth->fetchrow_hashref ) {
    	...
    	if ( $data->{'amount'} != $amount ) {
            ...
            C4::Stats::UpdateStats( my $branch = '', my $stattype = "fine_update", $amount, my $other = '', $data->{'itemnumber'}, my $itemtype = '', $data->{'borrowernumber'}, my $proccode = '' );
        } else {
...
# begin transaction
    ...
    C4::Stats::UpdateStats( my $branch = '', my $stattype = "fine_new", $amount, my $other = '', $itemnum, my $itemtype = '', $borrowernumber, my $proccode = '' );
