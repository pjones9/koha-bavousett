...
-- Add new fields to the reserves table
--
ALTER TABLE `reserves` 
ADD `lockPriority` BOOL NOT NULL ,
ADD `lowestPriority` BOOL NOT NULL ,
ADD `expirationDate` DATE NULL
...
--
-- Tables for the Rotating Collections
--
...
CREATE TABLE `collectionsTracking` (
